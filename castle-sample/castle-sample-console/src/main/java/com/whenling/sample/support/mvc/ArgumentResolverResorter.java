package com.whenling.sample.support.mvc;
...
public class ArgumentResolverResorter implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		newArgumentResolvers.set(indexArg, new EntityModelAttributeMethodProcessor(conversionService.getObject(), false));
		...
		newInitBinderArgumentResolvers.set(indexBinder, new EntityModelAttributeMethodProcessor(conversionService.getObject(), false));
